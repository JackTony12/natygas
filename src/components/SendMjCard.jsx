        ...
        >
          ...
          <div className="px-4 py-4 xs:px-6 xs:py-6 sm:px-8 sm:py-8 space-y-4 xs:space-y-6 sm:space-y-8 overflow-y-auto max-h-[calc(100vh-200px)] xs:max-h-[calc(100vh-180px)] sm:max-h-[80vh]">
            <div className="space-y-2 xs:space-y-3 sm:space-y-4">
              <label form='sector' className="text-xs xs:text-sm font-medium text-gray-600 uppercase tracking-wider">
                Seleccione el sector
              </label>
              <div className="grid grid-cols-2 gap-2 xs:gap-2.5 sm:gap-3">
                {["La-paz", "Cane", "Yarumela","Lejamani"].map((sector) => (
                  <label form='sector' key={sector} className="relative cursor-pointer">
                    <input
                      type="radio"
                      name="sector"
                      value={sector}
            ...
            <div className="space-y-2 xs:space-y-3 sm:space-y-4">
              <label form='tipo' className="flex justify-between text-xs xs:text-sm font-medium text-gray-600 uppercase tracking-wider">
